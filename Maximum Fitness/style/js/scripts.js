...
$('ul.grid img, .post a img, #about a img, .content a img, a.hover img').css("opacity","1.0");	
// ON MOUSE OVER
$('ul.grid img, .post a img, #about a img, .content a img, a.hover img').hover(function () {										  
// SET OPACITY TO 100%
